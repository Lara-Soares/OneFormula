...
function cadastrar(idPergunta, idusuario, isCorreto, notaGeral) {
    ...
    var instrucaoSql = `
        INSERT INTO resposta (idPergunta, idusuario, isCorreto, notaGeral) //22/01
        VALUES ('${idPergunta}, ${idusuario}, ${isCorreto}, ${notaGeral}');
    `;
